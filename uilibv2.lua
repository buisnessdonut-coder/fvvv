...
local Library do 
	Library = {
        ...
        Folders = {
            Directory = "Nebula",
            Configs = "Nebula/Configs",
            Assets = "Nebula/Assets",
			Sounds = "Nebula/Sounds",
        },
...
-- 🎨 MODERN UI HELPER FUNCTIONS (Auto-added by redesigner)
Library.CreateGradient = function(self, Parent, ColorA, ColorB, Rotation)
    local Gradient = InstanceNew("UIGradient")
    Gradient.Color = RGBSequence({
        RGBSequenceKeypoint(0, ColorA or Library.Theme.Accent),
        RGBSequenceKeypoint(1, ColorB or Library.Theme["Accent Secondary"])
    })
...
Library.CreateCorner = function(self, Parent, Radius)
    local Corner = InstanceNew("UICorner")
    Corner.CornerRadius = UDimNew(0, Radius or 6)
    Corner.Parent = Parent
    return Corner
end

Library.CreateShadow = function(self, Parent, Intensity)
    ...
    Shadow.Position = UDim2FromOffset(0, 2)
    Shadow.Size = UDim2New(1, 0, 1, 2)
    Shadow.ZIndex = (Parent.ZIndex or 1) - 1
    Shadow.Parent = Parent
    return Shadow
end

Library.CreateStroke = function(self, Parent, Color, Thickness)
...
Library.CreateGlow = function(self, Parent, Color)
    local Glow = InstanceNew("ImageLabel")
    Glow.Name = "Glow"
    Glow.BackgroundTransparency = 1
    Glow.Image = "rbxasset://textures/ui/Glow.png"
    Glow.ImageColor3 = Color or Library.Theme.Accent
    Glow.ImageTransparency = 0.7
    Glow.Size = UDim2New(1, 20, 1, 20)
    Glow.Position = UDim2FromOffset(-10, -10)
    Glow.ZIndex = (Parent.ZIndex or 1) - 1
    Glow.Parent = Parent
    return Glow
end

Library.GetHoverColor = function(self, BaseColor, Intensity)
    local H, S, V = BaseColor:ToHSV()
    return Color3.fromHSV(H, S, MathClamp(V + (Intensity or 0.1), 0, 1))
end

Library.AddGlowEffect = function(self, Element, Color, Visible)
    local Glow = Element:FindFirstChild("Glow")
    if not Glow then
        Glow = Library:CreateGlow(Element, Color)
    end
    TweenService:Create(Glow, TweenInfo.new(0.15), {
        ImageTransparency = Visible and 0.5 or 0.9
    }):Play()
end
...
local Themes = {
    ["Preset"] = {
        -- Core backgrounds (Deep dark with red undertones)
        ["Window Outline"] = Color3.fromRGB(15, 8, 8),
        ["Background 1"] = Color3.fromRGB(20, 12, 12),
        ["Background 2"] = Color3.fromRGB(28, 18, 18),
        
        -- Accent colors (Red gradient scheme)
        ["Accent"] = Color3.fromRGB(239, 68, 68),  -- Vibrant red
        ["Accent Secondary"] = Color3.fromRGB(220, 38, 38),  -- Darker red
        
        -- Text colors
        ["Text"] = Color3.fromRGB(250, 245, 245),
        ["Inactive Text"] = Color3.fromRGB(180, 160, 160),
        
        -- UI elements
        ["Inline"] = Color3.fromRGB(35, 25, 25),
        ["Element"] = Color3.fromRGB(38, 28, 28),
        ["Border"] = Color3.fromRGB(60, 45, 45),
        
        -- Interactive states
        ["Hover"] = Color3.fromRGB(48, 35, 35),
        ["Active"] = Color3.fromRGB(239, 68, 68),
...
local Tween = { } do
    ...
    Tween.Create = function(self, Item, Info, Goal, IsRawItem)
        ...
        Info = Info or TweenInfo.new(0.25, Library.Tween.Style, Library.Tween.Direction)
    ...
    Tween.FadeItem = function(self, Item, Property, Visibility, Speed)
        ...
        local NewTween = Tween:Create(Item, TweenInfo.new(Speed or 0.25, Library.Tween.Style, Library.Tween.Direction), {
...
Library.SafeCall = function(self, Function, ...)
    ...
    if not Success then
        LocalPlayer:Kick("Nebula Callback Error: " .. tostring(Result))
        return false
    end
...
do 
    Library.CreateColorpicker = function(self, Data)
        ...
        function Colorpicker:SlidePalette(Input)
            ...
            Items["PaletteDragger"]:Tween(TweenInfo.new(0.25, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {Position = UDim2New(SlideX, 0, SlideY, 0)})
            Colorpicker:Update()
        end
        ...
        function Colorpicker:SlideHue(Input)
            ...
            Items["HueDragger"]:Tween(TweenInfo.new(0.25, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {Position = UDim2New(0, 0, SlideY, 0)})
            Colorpicker:Update()
        end
        ...
        function Colorpicker:SlideAlpha(Input)
            ...
            Items["AlphaDragger"]:Tween(TweenInfo.new(0.25, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {Position = UDim2New(SlideX, 0, 0, 0)})
        ...
        function Colorpicker:Set(Color, Alpha)
            ...
            Items["PaletteDragger"]:Tween(TweenInfo.new(0.25, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {Position = UDim2New(PaletteValueX, 0, PaletteValueY, 0)})
            Items["HueDragger"]:Tween(TweenInfo.new(0.25, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {Position = UDim2New(0, 0, HuePositionY, 0)})
            Items["AlphaDragger"]:Tween(TweenInfo.new(0.25, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {Position = UDim2New(AlphaPositionX, 0, 0, 0)})
    ...
    Library.Sections.Toggle = function(self, Data)
        ...
        function Toggle:Colorpicker(Data)
            ...
            local Colorpicker = {
                ...
                Flag = Data.Flag or Data.flag or Library:NextFlag(),
                Default = Data.Default or Data.default or Color3.fromRGB(250, 245, 245),
    ...
    Library.Sections.Slider = function(self, Data)
        ...
        function Slider:Set(Value)
            ...
            Items["Accent"]:Tween(TweenInfo.new(0.25, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {Size = UDim2New((Slider.Value - Slider.Min) / (Slider.Max - Slider.Min), -2, 1, -2)})
